...
### This file create an hypothetical dataset relatively similar to the dataset used in the paper based 
# Nurses' Health Study cohort
# Outcome: Y: 0: healthy, 1: non-MSI-high cancer 2: MSI-high cancer 
...
# 3) bmi (continuous), normal with mean 25 and sd=2.75. Then correct extreme values
# sample.size
n.sample <- 65000
# set.seed for reproducibility
set.seed(314)
###################################################################################
# Simulate confounders according to distribution similar to the distribution in the 
