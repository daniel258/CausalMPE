...
#SBATCH -o CMPEn50KrareScen16EC.R.out               # Standard out goes to this file
#SBATCH -e CMPEn50KrareScen16EC.R.err               # Standard err goes to this file
#SBATCH --mail-type=END         # Mail when the job ends  
#write command-line commands below this line
module load gcc/6.2.0 R/3.5.1
Rscript CMPEn50KrareScen16EC.R