...
n.sample <- 50000
all.res <- read.csv("/Users/danielnevo/Dropbox/CausalMPE/R/CausalMPE/Sims/Results/n50000/all.res.csv")
all.res <- read.csv("/Users/danielnevo/Dropbox/CausalMPE/R/CausalMPE/Sims/Results/n50000/all.res.old.csv")
